...
function buildBaseItem(todo) {
  ...
  return {
    ...
    customOrder: todo.customOrder ?? todo.order?.custom ?? 0,
    categoryOrder: todo.categoryOrder ?? todo.order?.category ?? 0,
    favoriteOrder: todo.favoriteOrder ?? todo.order?.favorite ?? null,
    order: {
      custom: todo.customOrder ?? todo.order?.custom ?? 0,
