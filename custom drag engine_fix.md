...
> 위 상태는 2026-05-14 기록이다. 이후 즐겨찾기 drag in/out도 구현·수동 검증 이력이 있으며, 현재 중단 지점은 선택/bulk 이동이다. 최신 상태는 [웹 GPT 인수인계](WEB_GPT_HANDOFF.md)를 따른다. 아래 완료 항목을 신규 작업으로 다시 실행하지 않는다.
